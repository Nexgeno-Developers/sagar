...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('custom-pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label" for="name">{{ translate('Main Heading') }} <span class="text-danger">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <button type="button" class="btn btn-secondary btn-sm" id="addSectionButton">{{ translate('Add New Section') }}</button>
