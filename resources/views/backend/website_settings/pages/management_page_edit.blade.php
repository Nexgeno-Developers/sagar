...
<div class="form-group row">
                <label class="col-sm-6 col-from-label" for="name">{{ translate('Add Main Image') }}</label>
                <div class="col-sm-12">
                    <div class="input-group " data-toggle="aizuploader" data-type="image">
                        ...
                        <input type="hidden" class="selected-files" name="main_image" value="{{ $content['main_images'] ?? '' }}">
                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group " data-toggle="aizuploader" data-type="image">
                                                    ...
                                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input required type="hidden" class="selected-files" name="section_images[]" value="{{ $section['images'] }}">
                                                </div>
                                                <div class="file-preview"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea
                                						...
                                						required placeholder="{{ translate('Description') }}"
