    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-sm-{{ !empty($core_image) ? 3 : 6 }}">
                <div class="form-group mb-3">
                    <label>Image <span class="red">*</span></label>
                    <input class="form-control" type="file" id="core_image" name="core_image"
                        accept=".jpg,.jpeg,.png,.webp" @if (empty($core_image)) required @endif>
                </div>
            </div>
            @if (!empty($core_image))
            <div class="div-preview-image col-3 form-group mb-3">
            ...
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    <label>Description<span class="red">*</span></label>
                    <textarea class="form-control trumbowyg" name="core_content" rows="3" @if (empty($core_content))
                        required @endif>{{ $core_content }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-{{ !empty($policy_image) ? 3 : 6 }}">
                <div class="form-group mb-3">
                    <label>Image <span class="red">*</span></label>
                    <input class="form-control" type="file" id="policy_image" name="policy_image"
                        accept=".jpg,.jpeg,.png,.webp" @if (empty($policy_image)) required @endif>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    <label>Description<span class="red">*</span></label>
                    <textarea class="form-control trumbowyg" name="policy_content" rows="3" @if (empty($policy_content))
                        required @endif>{{ $policy_content }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    <div class="form-group mb-3 col-sm-{{ !empty($team->image) ? 9 : 12 }}">
                        <label>Image <span class="red">*</span> </label>
                        <input class="form-control" type="file" name="team_image[]" accept=".jpg,.jpeg,.png,.webp" @if
                            (empty($team->image)) required @endif>
                    </div>
                    @if (!empty($team->image))
                    <div class="div-preview-image col-3 form-group mb-3">
                    ...
                    <div class="col-6 form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="team_name[]" value="{{$team->name}}" @if
                            (empty($team->name)) required @endif>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Description <span class="red">*</span> </label>
                        <textarea class="form-control" name="team_description[]" rows="3" @if
                            (empty($team->description)) required @endif>{{$team->description}}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    <div class="col-12 form-group mb-3">
                        <label>Image <span class="red">*</span></label>
                        <input class="form-control" type="file" name="team_image[]" accept=".jpg,.jpeg,.png,.webp"
                            required>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Name <span class="red">*</span></label>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control trumbowyg" name="about2_content1" rows="3" @if
                        (empty($about2_content1)) required @endif>{{ $about2_content1 }}</textarea>
                </div>
            </div>
            <div class="col-sm-{{ !empty($about2_image1) ? 3 : 6 }}">
                <div class="form-group mb-3">
                    <label>About image <span class="red">*</span> </label>
                    <input class="form-control" type="file" id="about2_image1" name="about2_image1"
                        accept=".jpg,.jpeg,.png,.webp" @if (empty($about2_image1)) required @endif>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-{{ !empty($about2_image2) ? 3 : 6 }}">
                <div class="form-group mb-3">
                    <label>About image <span class="red">*</span></label>
                    <input class="form-control" type="file" name="about2_image2" accept=".jpg,.jpeg,.png,.webp" @if
                        (empty($about2_image2)) required @endif>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    <label>About Content <span class="red">*</span></label>
                    <textarea class="form-control trumbowyg" name="about2_content2" rows="3" @if
                        (empty($about2_content2)) required @endif>{{ $about2_content2 }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="form-group row mb-3">
                    <div class="col-sm-{{ !empty($mnv_image1) ? 3 : 6 }}">
                        <div class="form-group mb-3">
                            <label>Image<span class="red">*</span></label>
                            <input class="form-control" type="file" name="mnv_image1" accept=".jpg,.jpeg,.png,.webp" @if
                                (empty($mnv_image1)) required @endif>
                        </div>
                    </div>
                    @if (!empty($mnv_image1))
                    <div class="div-preview-image col-3 form-group mb-3">
                    ...
                    <div class="col-6 form-group mb-3">
                        ...
                        <textarea class="form-control" name="mnv_description1" maxlength="155" rows="3"
                            required>{{$mnv_description1}}</textarea>
                    </div>
                    <div class="col-sm-{{ !empty($mnv_bg_image1) ? 3 : 6 }}">
                        <div class="form-group mb-3">
                            <label>Background Image</label>
                            <input class="form-control" type="file" name="mnv_bg_image1" accept=".jpg,.jpeg,.png,.webp"
                                @if (empty($mnv_bg_image1)) required @endif>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group row mb-3">
                    <div class="col-sm-{{ !empty($mnv_image2) ? 3 : 6 }}">
                        <div class="form-group mb-3">
                            <label>Image</label>
                            <input class="form-control" type="file" name="mnv_image2" accept=".jpg,.jpeg,.png,.webp" @if
                                (empty($mnv_image2)) required @endif>
                        </div>
                    </div>
                    @if (!empty($mnv_image2))
                    <div class="div-preview-image col-3 form-group mb-3">
                    ...
                    <div class="col-6 form-group mb-3">
                        <label>Description</label>
                        <textarea class="form-control" name="mnv_description2" maxlength="155" rows="3"
                            required>{{$mnv_description2}}</textarea>
                    </div>
                    <div class="col-sm-{{ !empty($mnv_bg_image2) ? 3 : 6 }}">
                        <div class="form-group mb-3">
                            <label>Background Image</label>
                            <input class="form-control" type="file" name="mnv_bg_image2" accept=".jpg,.jpeg,.png,.webp"
                                @if (empty($mnv_bg_image2)) required @endif>
                        </div>
                    </div>
        ...
        <div class="col-sm-12">
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" maxlength="255" name="meta_title"
