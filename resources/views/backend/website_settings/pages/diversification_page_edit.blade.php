...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('custom-pages.update', $page->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-from-label" for="name">{{ translate('Main Heading') }} <span class="text-danger">*</span></label>
                <div class="col-sm-10">
                    <input required type="text" class="form-control" placeholder="{{ translate('Main Heading') }}" name="main_heading" value="{{ $content['main_heading'] ?? '' }}">
                </div>
            </div>            
            <div class="form-group row">
                <label class="col-sm-2 col-from-label" for="name">{{ translate('Main Sub Heading') }} <span class="text-danger">*</span></label>
                <div class="col-sm-10">
                    <input required type="text" class="form-control" placeholder="{{ translate('Main Sub Heading') }}" name="main_subheading" value="{{ $content['main_subheading'] ?? '' }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="about-page-content-target pt-4">
                    ...
                    @if (!empty($content))
                        @foreach ($content['section2'] as $index => $section)
