<form id="edit_home_form" action="{{url(route('custom-pages.update', $page->id))}}" method="post"
    ...
    <div class="row">
        ...
        <div class="col-sm-6 d-none">
            <div class="form-group mb-3">
                <label>Slug (URL) <span class="red">*</span><span class="small"> (Deafult Pages Slug Not Editable)
                    </span></label>
                <input readonly type="text" class="form-control" maxlength="155" value="{{ $page->slug }}" name="slug"
                    required>
            </div>
        </div>
        ...
        <div class="col-sm-6 d-none">
            <div class="form-group mb-3">
                <label>Status <span class="red">*</span><span class="small"> (Deafult Pages Status Not Editable)
                    </span></label>
            ...
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    ...
                    <div class="col-6 form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="banner_text[]" maxlength="155"
                            value="{{$banner->text}}" @if (empty($banner->text)) required @endif>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Banner Button Text <span class="red">*</span></label>
                        <input class="form-control" type="text" maxlength="155" value="{{$banner->button}}"
                            id="banner_button[]" name="banner_button[]" @if (empty($banner->button)) required @endif>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Banner Url <span class="red">*</span></label>
                        <input class="form-control" type="text" maxlength="155" value="{{$banner->url}}"
                            id="banner_url[]" name="banner_url[]" @if (empty($banner->url)) required @endif>
                    </div>
        ...
        <div class="row gallery-image-row">
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    ...
                    <div class="col-6 form-group mb-3">
                        <label>Banner Button Text <span class="red">*</span></label>
                        <input class="form-control" type="text" id="banner_button[]" maxlength="155"
                            name="banner_button[]" required>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Banner Url <span class="red">*</span></label>
                        <input class="form-control" type="text" id="banner_url[]" maxlength="155" name="banner_url[]"
                            required>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    ...
                    <select class="form-select select2" name="product_category_id[]" multiple required>
                        @foreach ($Industry as $product_category )
        ...
        <div class="row gallery-image-row2">
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    <div class="col-6 form-group mb-3">
                        <label>Image</label>
                        <input class="form-control" type="file" name="wwd_image[]" accept=".jpg,.jpeg,.png,.webp" @if
                            (empty($wwd_data->image)) required @endif>
                    </div>
                    ...
                    <div class="col-6 form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="wwd_text[]" maxlength="155"
                            value="{{$wwd_data->text}}" @if (empty($wwd_data->text)) required @endif>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Content<span class="red">*</span></label>
                        <textarea class="form-control" maxlength="500" name="wwd_content[]" rows="3" @if
                            (empty($wwd_data->content)) required @endif>{{$wwd_data->content}}</textarea>
                    </div>
        ...
        <div class="row gallery-image-row2">
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    <div class="col-6 form-group mb-3">
                        <label>Image</label>
                        <input class="form-control" type="file" id="banner" name="wwd_image[]"
                            accept=".jpg,.jpeg,.png,.webp" required>
                    </div>
                    <div class="col-6 form-group mb-3">
                        <label>Text</label>
                    ...
                    <div class="col-6 form-group mb-3">
                        <label>Content<span class="red">*</span></label>
                        <textarea class="form-control" maxlength="500" name="wwd_content[]" rows="3"
                            required></textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="row gallery-image-row3">
            <div class="col-md-9">
                <div class="form-group row mb-3 ">
                    <div class="col-6 form-group mb-3">
                        <label>Text</label>
                        <input type="text" class="form-control" maxlength="155" value="{{$row->text}}"
                            name="activities_text[]" @if (empty($row->text)) required @endif>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3 ">
                            <label>Youtube url</label>
                            <input class="form-control" type="text" value="{{$row->url}}" name="activities_url[]" @if
                                (empty($row->url)) required @endif>
                        </div>
                    </div>
                    @if (!empty($row->url))
                    <div class="div-preview-iframe mt-2">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/{{$row->url}}"
    ...
    <div class="col-md-12">
        <div class="col-12 form-group mb-3">
            <label>Content<span class="red">*</span></label>
            <textarea class="form-control" name="scp_content" rows="3" @if (empty($scp_content)) required
                @endif>{{$scp_content}}</textarea>
        </div>
        <div class="form-group row mb-3 ">
            <div class="form-group mb-3 col-sm-{{ !empty($scp_image1) ? 3 : 6 }}">
                <label>Image</label>
                <input class="form-control" type="file" name="scp_image1" accept=".jpg,.jpeg,.png,.webp" @if
                    (empty($scp_image1)) required @endif>
            </div>
            @if (!empty($scp_image1))
            <div class="div-preview-image col-3 form-group mb-3">
            ...
            <div class="col-6 form-group mb-3">
                <label>Text</label>
                <input type="text" class="form-control" maxlength="155" name="scp_text1" value="{{$scp_text1}}" @if
                    (empty($scp_text1)) required @endif>
            </div>
            <div class="col-6 form-group mb-3">
                <label>PDF</label>
        ...
        <div class="form-group row mb-3 ">
            <div class="form-group mb-3 col-sm-{{ !empty($scp_image2) ? 3 : 6 }}">
                <label>Image</label>
                <input class="form-control" type="file" name="scp_image2" accept=".jpg,.jpeg,.png,.webp" @if
                    (empty($scp_image2)) required @endif>
            </div>
            @if (!empty($scp_image2))
            <div class="div-preview-image col-3 form-group mb-3">
            ...
            <div class="col-6 form-group mb-3">
                <label>Text</label>
                <input type="text" class="form-control" maxlength="155" name="scp_text2" value="{{$scp_text2}}" @if
                    (empty($scp_text2)) required @endif>
            </div>
            <div class="col-6 form-group mb-3">
                <label>URL</label>
                <input type="text" class="form-control" maxlength="155" name="scp_url" value="{{$scp_url}}" @if
                    (empty($scp_url)) required @endif>
            </div>
        </div>
        <div class="form-group row mb-3 ">
            <div class="form-group mb-3 col-sm-{{ !empty($scp_image3) ? 3 : 6 }}">
                <label>Image</label>
                <input class="form-control" type="file" name="scp_image3" accept=".jpg,.jpeg,.png,.webp" @if
                    (empty($scp_image3)) required @endif>
            </div>
            @if (!empty($scp_image3))
            <div class="div-preview-image col-3 form-group mb-3">
            ...
            <div class="col-6 form-group mb-3">
                <label>Text</label>
                <input type="text" class="form-control" maxlength="155" name="scp_text3" value="{{$scp_text3}}" @if
                    (empty($scp_text3)) required @endif>
            </div>
            <div class="col-6 form-group mb-3">
                <label>PDF</label>
    ...
    <div class="col-sm-12">
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" maxlength="155" name="meta_title" value="{{ $page->meta_title }}"
                required>
        </div>
        <div class="form-group mb-3">
