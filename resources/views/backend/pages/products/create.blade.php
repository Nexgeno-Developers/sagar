<form id="create_product_form" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="form-group col-6 mb-3">
            ...
            <textarea required name="function_description" class="form-control trumbowyg">{{ old('function_description') }}</textarea>
        </div>

        <div class="form-group col-6 mb-3">
            <label>Product Description<span class="red">*</span></label>
            <textarea required name="product_description" class="form-control trumbowyg">{{ old('product_description') }}</textarea>
        </div>

        <div class="form-group col-6 mb-3">
            <label>Product Information<span class="red">*</span></label>
            <textarea required name="product_information" class="form-control trumbowyg">{{ old('product_information') }}</textarea>
        </div>

        <div class="form-group col-6 mb-3">
            <label>Delivery Description<span class="red">*</span></label>
            <textarea required name="delivery_description" class="form-control trumbowyg">{{ old('delivery_description') }}</textarea>
        </div>
