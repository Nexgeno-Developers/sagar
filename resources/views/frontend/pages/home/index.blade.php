...
<main class="home-page">
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000"
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item @if($index==0) active @endif">
                    <img src="{{ asset('storage/' . $banner->image) }}" loading="lazy" class="d-block w-100 carousel-image" alt="...">
                    <div class="carousel-caption banner_contents">
                        <h5>{{$banner->text}}</h5>
                        <a href="{{$banner->url}}" class="banner_view_button"
                            aria-label="banner slider button">{{$banner->button}}</a>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <section class="white_section industry_we_cater py-md-5 py-4">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-md-6">
                    <h2 class="product_heading text-center pb-lg-4 pb-md-3 float-start"><span
                            class="our">INDUSTRY</span> WE CATER</h2>
                </div>
                <div class="col-md-6 d-md-block d-none">
                    <a href="/industries" class="btn a_btn blue_btn float-md-end float-start"
                        ...
                        <div class="d-flex industry_content">
                            ...
                            <span class="industry_arrow_link pe-lg-3">
                                <img class="rotate45" src="/assets/frontend/images/home/right_arrow_45deg.png"
                                    alt="rotate 45 deg arrow" loading="lazy">
                            </span>
                        </div>
                    </a>
                </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-md-6 d-md-block d-none">
                    <a href="{{route('what_we_do')}}"
                        ...
                        aria-label="know about our works">
                        View All
                    </a>
                </div>
            </div>
            ...
            <div class="row justify-content-between position-relative">
                ...
                <div class="col-12">
                    <div class="why_sscpl_bg_img">
                        <h2 class="product_heading text-light text-center pt-lg-5 pt-3 mt-md-4">SERVICES & SOLUTIONS
                        </h2>
                        <div class="row pt-lg-5 pt-3">
                            ...
                            <div class="col-md-3 col-6 sscl_contents_main_div text-center pb-lg-5 pb-3">
                                <div class="sscl_img_div" loading="lazy"> <img
                                        src="/assets/frontend/images/home/packaging.png" alt="" class="sscl_img"></div>
                                <p class="sscl_content mt-md-3">Packaging</p>
                            </div>
                            <div class="col-md-3 col-6 sscl_contents_main_div text-center pb-lg-5 pb-3">
                                <div class="sscl_img_div" loading="lazy"> <img
                                        src="/assets/frontend/images/home/commitment.png" alt="" class="sscl_img"></div>
                                <p class="sscl_content mt-md-3">Commitment</p>
                            </div>
                            <div class="col-md-3 col-6 sscl_contents_main_div text-center pb-lg-5 pb-3">
                                <div class="sscl_img_div" loading="lazy"> <img
                                        src="/assets/frontend/images/home/delivery.png" alt="" class="sscl_img"></div>
                            ...
                            <div class="col-md-3 col-6 sscl_contents_main_div text-center pb-lg-5 pb-3">
                                <div class="sscl_img_div" loading="lazy"> <img
                                        src="/assets/frontend/images/home/compliances.png" alt="" class="sscl_img">
                                </div>
                                <p class="sscl_content mt-md-3">Compliances</p>
                            </div>
                            <div class="col-md-3 col-6 sscl_contents_main_div text-center pb-lg-5 pb-3">
                                <div class="sscl_img_div" loading="lazy"> <img
                                        src="/assets/frontend/images/home/customer_support.png" alt="" class="sscl_img">
                                </div>
                ...
                <div class="owl-theme owl-carousel" id="future_activity_slider">
                    ...
                    <div class="col-12 future_activites_main_div">
                        <div class="card">
                            ...
                            <img src="/assets/frontend/images/home/unnamed.jpg" data-src="https://img.youtube.com/vi/{{ $row->url }}/hqdefault.jpg"
    class="card-img-top lazy"
    alt="card-img-top">
    <div class="card-body">
        <h5 class="card-title">{{$row->text}}</h5>
        <button type="button" class="btn gallery_yt_video" aria-label="Youtube btn"
            data-youtube-url="https://www.youtube.com/embed/{{$row->url}}">
    ...
    <section class="white_section supply_chain_partner text-light bg-light pb-md-5 py-md-5 py-4 paddingbtm100">
        <div class="container">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe id="videoIframe" width="100%" height="480" src=""
