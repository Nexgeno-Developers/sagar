...
<main class="product_categories_page">
                ...
                <div class="col-md-3 sidebar">
                    <form action="{{ route('products_s') }}" method="GET" id="searchForm">
                        <div class="search-bar-filter">
                            ...
                            <input type="text" name="search" class="product-search form-control"
                            ...
                            <ul class="list-group filter_list">
                                ...
                                <li
                                    ...
                                    <label style="cursor:pointer">
                                        <input style="cursor:pointer" type="checkbox" class="category_checkbox"
                                            id="category_ids" value="{{ $category->id }}"
                                            onchange="updateCategoryIds(this)" @if(is_array($categoryIds) &&
                                            in_array($category->id, $categoryIds)) checked @endif
                                        >
                                        {{ $category->title }}
                                    </label>
                                </li>
    ...
    <div class="modal fade product_form" id="exampleModalCenter" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add_partner_us_form" action="{{ route('form.save') }}" method="post"
                        ...
                        <div class="form-group"><input required type="text" name="company_name" class="form-control"
                                placeholder="Company Name"></div>
                        <div class="form-group"><input required type="text" name="full_name" class="form-control"
                                placeholder="Full Name"></div>

                        <select required name="product" id="productSelect" class="select2 form-select">
                        ...
                        <div class="form-group"> <input type="number" class="form-control" name="quantity" required
                                placeholder="Quantity" min="0"></div>
                        <div class="form-group"><input required type="email" name="email" class="form-control"
                                placeholder="Email Address"></div>

                        <textarea class="col-12 mb-3" name="message" id="message" placeholder="Message"
                            rows="2"></textarea>
