...
(function() {
	...
	var wrapper_selector = gt.wrapper_selector || '.gtranslate_wrappers';

	var switcher_text_color = gt.switcher_text_color || '#333';
	var switcher_arrow_color = gt.switcher_arrow_color || '#333';
	var switcher_border_color = gt.switcher_border_color || '#ccc';
	var switcher_background_color = gt.switcher_background_color || '#fff';
	var switcher_background_shadow_color = gt.switcher_background_shadow_color || '#fff';
	var switcher_background_hover_color = gt.switcher_background_hover_color || '#fff';
	var dropdown_text_color = gt.dropdown_text_color || '#333';
	...
	widget_css += u_class + ' .gt_switcher .gt_selected{background:' + switcher_background_color + ' linear-gradient(180deg, ' + switcher_background_shadow_color + ' 0%, ' + switcher_background_color + ' 70%);position:relative;z-index:99}';
	...
	if (switcher_horizontal_position != 'inline')
		widget_code = '<div class="gt_switcher_wrappers" style="position:absolute;">' + widget_code + '</div>';
